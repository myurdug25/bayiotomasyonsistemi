...
class WarehouseBranchResolver
{
    ...
    private function branchCodeFromCustomerMetadata(?Customer $customer): ?string
    {
        ...
        $paths = [
            ...
            'integrations.logo.payload.cyphcode',
            'integrations.logo.payload.raw.CYPHCODE',
            'integrations.logo.payload.raw.AUTHCODE',
            'integrations.logo.payload.raw.AUTHORITY',
            'integrations.logo.payload.raw.AUTHORIZATION_CODE',
